...
export function loadBackendEnv(): BackendEnv {
  return {
    ...
    groq: { apiKeys: [required('GROQ_API_KEY'), process.env.GROQ_API_KEY_FALLBACK], sttModel: process.env.GROQ_STT_MODEL ?? 'whisper-large-v3-turbo', chatModel: process.env.GROQ_CHAT_MODEL ?? 'llama-3.3-70b-versatile' },
  };
}
