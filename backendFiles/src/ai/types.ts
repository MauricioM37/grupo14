export const AI_CAPABILITY = { STT: 'stt', CHAT: 'chat' } as const;
...
export interface ProviderAttempt { step: string; provider: 'groq1' | 'groq2'; capability: AiCapability; status: ProviderStatus; code?: string; httpStatus?: number; retryable: boolean; category?: ProviderErrorCategory; message: string; }
...
export interface GroqProviderConfig { apiKeys: [string, string?]; sttModel: string; chatModel: string; baseUrl?: string; }
